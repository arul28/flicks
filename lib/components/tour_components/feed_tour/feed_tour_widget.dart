...
import 'feed_tour_model.dart';
export 'feed_tour_model.dart';

class FeedTourWidget extends StatefulWidget {
  const FeedTourWidget({Key? key}) : super(key: key);

  @override
  _FeedTourWidgetState createState() => _FeedTourWidgetState();
}

class _FeedTourWidgetState extends State<FeedTourWidget> {
  late FeedTourModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedTourModel());
  }
