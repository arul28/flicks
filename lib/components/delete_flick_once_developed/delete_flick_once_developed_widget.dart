...
class _DeleteFlickOnceDevelopedWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<OldSessionPicsRecord>(
      stream: OldSessionPicsRecord.getDocument(widget.oldSessionPics!),
      builder: (context, snapshot) {
        ...
        final containerOldSessionPicsRecord = snapshot.data!;
        return Material(
                            ...
                            onPressed: () async {
                              if ((currentUserDocument?.pinned?.toList() ?? [])
                                ...
                                await showAlignedDialog(
                                  ...
                                  builder: (dialogContext) {
                                    return Material(
                                      color: Colors.transparent,
                                      child:
                                          DeleteFlickOnceDevelopedErrorWidget(),
                                    );
                                  },
                                ).then((value) => setState(() {}));
                              } else {
                                await FirebaseStorage.instance
                                    .refFromURL(
                                        containerOldSessionPicsRecord.imagePath)
                                    .delete();
