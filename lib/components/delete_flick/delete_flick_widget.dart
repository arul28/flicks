...
class _DeleteFlickWidgetState extends State<DeleteFlickWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CurrentSessionPicsRecord>(
      stream: CurrentSessionPicsRecord.getDocument(widget.currentSessionPics!),
      builder: (context, snapshot) {
        ...
        final containerCurrentSessionPicsRecord = snapshot.data!;
        return Material(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await FirebaseStorage.instance
                                .refFromURL(
                                    containerCurrentSessionPicsRecord.imagePath)
                                .delete();
