...
import 'create_profile_apple_user_model.dart';
export 'create_profile_apple_user_model.dart';

class CreateProfileAppleUserWidget extends StatefulWidget {
  const CreateProfileAppleUserWidget({Key? key}) : super(key: key);

  @override
  _CreateProfileAppleUserWidgetState createState() =>
      _CreateProfileAppleUserWidgetState();
}

class _CreateProfileAppleUserWidgetState
    extends State<CreateProfileAppleUserWidget> {
  late CreateProfileAppleUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProfileAppleUserModel());
                          ...
                          onPressed: () async {
                            ...
                            if (_model.usernameCount == 0) {
                              await currentUserReference!
                                ...
                                fullName: _model.usernameCreateController.text,
