...
class _ResetPasswordWidgetState extends State<ResetPasswordWidget>
  ...
  void initState() {
    ...
    _model.newpassconfirmController ??= TextEditingController();
  }
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 24.0),
                                  child: Text(
                                    'Enter your current account password and new password ',
                                    textAlign: TextAlign.center,
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .currentPassControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      20.0, 20.0, 20.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.newpassconfirmController,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    validator: _model
                                        .newpassconfirmControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
