...
import 'manage_friends_option_model.dart';
export 'manage_friends_option_model.dart';

class ManageFriendsOptionWidget extends StatefulWidget {
  const ManageFriendsOptionWidget({Key? key}) : super(key: key);

  @override
  _ManageFriendsOptionWidgetState createState() =>
      _ManageFriendsOptionWidgetState();
}

class _ManageFriendsOptionWidgetState extends State<ManageFriendsOptionWidget>
    with TickerProviderStateMixin {
  late ManageFriendsOptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageFriendsOptionModel());
