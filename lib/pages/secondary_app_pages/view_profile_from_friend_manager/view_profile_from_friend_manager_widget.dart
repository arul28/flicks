...
import 'view_profile_from_friend_manager_model.dart';
export 'view_profile_from_friend_manager_model.dart';

class ViewProfileFromFriendManagerWidget extends StatefulWidget {
  const ViewProfileFromFriendManagerWidget({
    Key? key,
  ...
  @override
  _ViewProfileFromFriendManagerWidgetState createState() =>
      _ViewProfileFromFriendManagerWidgetState();
}

class _ViewProfileFromFriendManagerWidgetState
    extends State<ViewProfileFromFriendManagerWidget> {
  late ViewProfileFromFriendManagerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewProfileFromFriendManagerModel());
