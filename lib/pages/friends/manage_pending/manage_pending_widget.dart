...
import 'manage_pending_model.dart';
export 'manage_pending_model.dart';

class ManagePendingWidget extends StatefulWidget {
  const ManagePendingWidget({Key? key}) : super(key: key);

  @override
  _ManagePendingWidgetState createState() => _ManagePendingWidgetState();
}

class _ManagePendingWidgetState extends State<ManagePendingWidget>
    with TickerProviderStateMixin {
  late ManagePendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManagePendingModel());
  }
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'users you have sent a friend request to',
