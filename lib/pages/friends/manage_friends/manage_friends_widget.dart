...
import 'manage_friends_model.dart';
export 'manage_friends_model.dart';

class ManageFriendsWidget extends StatefulWidget {
  const ManageFriendsWidget({Key? key}) : super(key: key);

  @override
  _ManageFriendsWidgetState createState() => _ManageFriendsWidgetState();
}

class _ManageFriendsWidgetState extends State<ManageFriendsWidget> {
  late ManageFriendsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ManageFriendsModel());
  }
