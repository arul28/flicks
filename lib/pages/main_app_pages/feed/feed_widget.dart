                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              await pageViewOldSessionPicsRecord.reference.update(createOldSessionPicsRecordData(
                                                                                isPinned: false,
                                                                              ));
                                                                              await cardContainerPinnedRecordList.where((e) => pageViewOldSessionPicsRecord.imagePath == e.imagePath).toList().first.reference.delete();
                                                                            },
                                                                            child:
                                                                                Icon(
                                                                              Icons.push_pin,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              await PinnedRecord.createDoc(currentUserReference!).set(createPinnedRecordData(
                                                                                imagePath: pageViewOldSessionPicsRecord.imagePath,
                                                                                timeTaken: pageViewOldSessionPicsRecord.timeTaken,
                                                                              ));

                                                                              await currentUserReference!.update(createUsersRecordData(
                                                                                lastPinAddedTime: getCurrentTimestamp,
                                                                              ));
                                                                            },
                                                                            child:
                                                                                Icon(
